...
namespace SportSchool.AdminServiceReference {
    ...
    public interface IAdminService {
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IAdminService/GetInstructorBy", ReplyAction="http://tempuri.org/IAdminService/GetInstructorByResponse")]
        SportSchoolClassLibrary.Instructor GetInstructorBy(string email);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IAdminService/GetInstructorBy", ReplyAction="http://tempuri.org/IAdminService/GetInstructorByResponse")]
        System.Threading.Tasks.Task<SportSchoolClassLibrary.Instructor> GetInstructorByAsync(string email);
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IAdminService/FindLearners", ReplyAction="http://tempuri.org/IAdminService/FindLearnersResponse")]
        [System.ServiceModel.ServiceKnownTypeAttribute(typeof(SportSchoolClassLibrary.Instructor))]
        [System.ServiceModel.ServiceKnownTypeAttribute(typeof(SportSchoolClassLibrary.Learner))]
        SportSchoolClassLibrary.Learner[] FindLearners(SportSchoolClassLibrary.Person person, [System.ServiceModel.MessageParameterAttribute(Name="Person")] string Person1);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IAdminService/FindLearners", ReplyAction="http://tempuri.org/IAdminService/FindLearnersResponse")]
        System.Threading.Tasks.Task<SportSchoolClassLibrary.Learner[]> FindLearnersAsync(SportSchoolClassLibrary.Person person, [System.ServiceModel.MessageParameterAttribute(Name="Person")] string Person1);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IAdminService/FindInstructors", ReplyAction="http://tempuri.org/IAdminService/FindInstructorsResponse")]
        [System.ServiceModel.ServiceKnownTypeAttribute(typeof(SportSchoolClassLibrary.Instructor))]
        [System.ServiceModel.ServiceKnownTypeAttribute(typeof(SportSchoolClassLibrary.Learner))]
        SportSchoolClassLibrary.Instructor[] FindInstructors(SportSchoolClassLibrary.Person person, [System.ServiceModel.MessageParameterAttribute(Name="Person")] string Person1);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IAdminService/FindInstructors", ReplyAction="http://tempuri.org/IAdminService/FindInstructorsResponse")]
        System.Threading.Tasks.Task<SportSchoolClassLibrary.Instructor[]> FindInstructorsAsync(SportSchoolClassLibrary.Person person, [System.ServiceModel.MessageParameterAttribute(Name="Person")] string Person1);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IAdminService/ModifyLearner", ReplyAction="http://tempuri.org/IAdminService/ModifyLearnerResponse")]
        void ModifyLearner(SportSchoolClassLibrary.Learner learner);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IAdminService/ModifyLearner", ReplyAction="http://tempuri.org/IAdminService/ModifyLearnerResponse")]
        System.Threading.Tasks.Task ModifyLearnerAsync(SportSchoolClassLibrary.Learner learner);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IAdminService/ModifyInstructor", ReplyAction="http://tempuri.org/IAdminService/ModifyInstructorResponse")]
        void ModifyInstructor(SportSchoolClassLibrary.Instructor instructor);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IAdminService/ModifyInstructor", ReplyAction="http://tempuri.org/IAdminService/ModifyInstructorResponse")]
        System.Threading.Tasks.Task ModifyInstructorAsync(SportSchoolClassLibrary.Instructor instructor);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IAdminServiceChannel : SportSchool.AdminServiceReference.IAdminService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class AdminServiceClient : System.ServiceModel.ClientBase<SportSchool.AdminServiceReference.IAdminService>, SportSchool.AdminServiceReference.IAdminService {
        ...
        public SportSchoolClassLibrary.Instructor GetInstructorBy(string email) {
            return base.Channel.GetInstructorBy(email);
        }
        
        public System.Threading.Tasks.Task<SportSchoolClassLibrary.Instructor> GetInstructorByAsync(string email) {
            return base.Channel.GetInstructorByAsync(email);
        }
        ...
        public SportSchoolClassLibrary.Learner[] FindLearners(SportSchoolClassLibrary.Person person, string Person1) {
            return base.Channel.FindLearners(person, Person1);
        }
        
        public System.Threading.Tasks.Task<SportSchoolClassLibrary.Learner[]> FindLearnersAsync(SportSchoolClassLibrary.Person person, string Person1) {
            return base.Channel.FindLearnersAsync(person, Person1);
        }
        
        public SportSchoolClassLibrary.Instructor[] FindInstructors(SportSchoolClassLibrary.Person person, string Person1) {
            return base.Channel.FindInstructors(person, Person1);
        }
        
        public System.Threading.Tasks.Task<SportSchoolClassLibrary.Instructor[]> FindInstructorsAsync(SportSchoolClassLibrary.Person person, string Person1) {
            return base.Channel.FindInstructorsAsync(person, Person1);
        }
        
        public void ModifyLearner(SportSchoolClassLibrary.Learner learner) {
            base.Channel.ModifyLearner(learner);
        }
        
        public System.Threading.Tasks.Task ModifyLearnerAsync(SportSchoolClassLibrary.Learner learner) {
            return base.Channel.ModifyLearnerAsync(learner);
        }
        
        public void ModifyInstructor(SportSchoolClassLibrary.Instructor instructor) {
            base.Channel.ModifyInstructor(instructor);
        }
        
        public System.Threading.Tasks.Task ModifyInstructorAsync(SportSchoolClassLibrary.Instructor instructor) {
            return base.Channel.ModifyInstructorAsync(instructor);
        }
    }
}
